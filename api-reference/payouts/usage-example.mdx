...
```bash
# Base URLs
BASE_URL_LIVE="https://api.bitnob.com"
BASE_URL_SANDBOX="<your-sandbox-url>"     # provided with your account

# API credentials — from your dashboard, under API keys
CLIENT_ID="<your-client-id>"
CLIENT_SECRET="<your-client-secret>"      # shown once — store it securely
```
