...
The authentication scheme on this page is a summary. [API authentication](/api-reference/authentication/authentication) is the source of truth for the signing spec.
...
| X-Auth-Nonce | 16 cryptographically random bytes, hex-encoded |
| X-Auth-Signature | HMAC-SHA256 signature (hex-encoded): see below |

```http
X-Auth-Client:    <your-client-id>
X-Auth-Timestamp: 1751452800
X-Auth-Nonce:     3f9a1c2e7b904d219e5a2c8f6b1d0a4e
