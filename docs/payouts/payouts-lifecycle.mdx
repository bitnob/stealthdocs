...
description: "A payout is a record that moves from `QUOTE` to `COMPLETED` or `FAILED`. This page explains what moves it forward, where it can stall, and which transitions emit a webhook."
---
