...
description: "Vaults, wallets, policies, and approvals: the objects to model your Enterprise integration around."
related:
  - /docs/enterprise/authentication
  - /docs/enterprise/exchange-integration-guide
---
These are the building blocks behind Bitnob Enterprise wallet infrastructure. Understanding them will help you model your integration correctly and configure policies that reflect your actual security requirements.
